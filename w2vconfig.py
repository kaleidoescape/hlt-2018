...
max_vocab_size = None       #if there are more unique words than this, 
...
min_count = 3               #prune words with counts of less than min_count
                            #default=5
...
batch_words = 1000          #target size in words for batches passed to workers
                            #default=10000
